...
Notifications, more specifically toast messages, are pretty common in react. In this example, we'll be demonstrating how you can use a function to display toast notifications with the  `useContext` hook in React.
